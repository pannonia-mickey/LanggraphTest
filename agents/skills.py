...
# Create custom middleware that injects skill descriptions into the system prompt. This middleware makes skills
# discoverable without loading their full content upfront.
