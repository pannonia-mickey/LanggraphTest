...
from deep_agents_from_scratch.prompt import SUMMARIZE_WEB_SEARCH
...
def process_search_results(results: dict) -> list[dict]:
    ...
    Args:
        results: Google search results dictionary
    ...
    HTTPX_CLIENT = httpx.Client(follow_redirects=True, timeout=30.0)  # Add 30 second timeout
    ...
    for result in results.get('organic', []):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                raw_content = markdownify(html=response.text)
